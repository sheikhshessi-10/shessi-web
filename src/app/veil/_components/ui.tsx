...
export function PrimaryButton({
  ...
  return (
    <a
      href={href}
      className={`group relative inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-b from-primary to-[#0e9bb8] px-5 py-3 text-sm font-semibold text-[#02141a] shadow-[0_1px_0_rgba(255,255,255,0.3)_inset,0_8px_24px_-8px_rgba(34,211,238,0.6)] transition-all duration-200 hover:from-primary-bright hover:to-primary hover:shadow-[0_1px_0_rgba(255,255,255,0.4)_inset,0_10px_32px_-8px_rgba(103,232,249,0.7)] active:scale-[0.98] ${className}`}
    >
      {children}
    </a>
  );
